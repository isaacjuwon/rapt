...
class ShareSoldNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
                    ->subject('Shares Sold Successfully!')
                    ->markdown('emails.share.share-sold', ['shareTransaction' => $this->shareTransaction, 'notifiable' => $notifiable]);
    }
