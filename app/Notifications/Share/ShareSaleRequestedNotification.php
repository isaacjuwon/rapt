...
class ShareSaleRequestedNotification extends Notification implements ShouldQueue
{
    use Queueable;
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
                    ->subject('Share Sale Request Received')
                    ->markdown('emails.share.share-sale-requested', ['shareTransaction' => $this->shareTransaction, 'notifiable' => $notifiable]);
    }
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'status' => $this->shareTransaction->status,
        ];
    }
}