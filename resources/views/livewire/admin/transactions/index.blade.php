...
new #[Title('Manage Transactions')] class extends Component {
    ...
    /**
     * Get the transactions with pagination.
     */
    #[Computed]
     ...
     */
    public function confirmDeleteTransaction(): void
    {
        Transaction::destroy($this->selected_transaction->id);
...
<div class="space-y-6">
    <div class="flex w-full flex-col gap-2 sm:flex-row sm:items-center">
        <div>
            ...
            <flux:subheading>
                {{ __('Manage transactions in your application. You can view and delete transactions.') }}
            </flux:subheading>
        </div>
                ...
                <flux:table.row
                    ...
                    <flux:table.cell
                        ...
                        <div class="flex flex-col">
                            ...
                            <span class="text-sm text-zinc-500">{{ $transaction->user->name ?? 'N/A' }}</span>
                        </div>
                    </flux:table.cell>
    ...
    <flux:modal name="delete-transaction" class="max-w-md">
        <div class="space-y-4">
            ...
            <div class="flex justify-end gap-2">
                <flux:button
                    wire:click="$dispatch('close-modal', 'delete-transaction')"
                    variant="ghost">
                    {{ __('Cancel') }}
                </flux:button>

                <flux:button
                    wire:click="confirmDeleteTransaction"
                    variant="danger">
