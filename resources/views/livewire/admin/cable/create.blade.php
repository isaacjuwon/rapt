...
new #[Title('Create Cable Plan')] class extends Component { // Changed title
    public string $name = '';
    ...
    public function store(): void
    {
        ...
        CablePlan::create($validated); // Changed model

        Toaster::success(__('Cable Plan created successfully.')); // Changed text
...
<div class="space-y-6">
    <div class="flex w-full flex-col gap-2 sm:flex-row sm:items-center">
        <div>
            <flux:heading size="xl">{{ __('Create Cable Plan') }}</flux:heading> // Changed text
            <flux:subheading>
                {{ __('Fill in the details to create a new cable plan.') }} // Changed text
            </flux:subheading>
        </div>
