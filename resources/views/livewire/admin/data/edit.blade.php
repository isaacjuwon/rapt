...
new #[Title('Edit Data Plan')] class extends Component {
    #[Locked]
    ...
    public function mount(DataPlan $dataPlan): void
    {
        $this->dataPlan = $dataPlan;
        $this->name = $dataPlan->name;
        $this->description = $dataPlan->description;
        $this->status = $dataPlan->status;
        $this->api_code = $dataPlan->api_code;
        $this->service_id = $dataPlan->service_id;
        $this->reference = $dataPlan->reference;
        $this->type = $dataPlan->type;
        $this->duration = $dataPlan->duration;
        $this->price = $dataPlan->price;
        $this->discounted_price = $dataPlan->discounted_price;
        $this->brand_id = $dataPlan->brand_id;
    }
    ...
    public function update(): void
    {
        ...
        $this->dataPlan->update($validated);

        Toaster::success(__('Data Plan updated successfully.'));
...
<div class="space-y-6">
    <div class="flex w-full flex-col gap-2 sm:flex-row sm:items-center">
        <div>
            <flux:heading size="xl">{{ __('Edit Data Plan') }}</flux:heading>
            <flux:subheading>
                {{ __('Update the details for the data plan: :dataPlanName.', ['dataPlanName' => $this->dataPlan->name]) }}
            </flux:subheading>
        </div>
