...
new #[Title('Create Education Plan')] class extends Component { // Changed title
    public string $name = '';
    ...
    public function store(): void
    {
        ...
        EducationPlan::create($validated); // Changed model

        Toaster::success(__('Education Plan created successfully.')); // Changed text
...
<div class="space-y-6">
    <div class="flex w-full flex-col gap-2 sm:flex-row sm:items-center">
        <div>
            <flux:heading size="xl">{{ __('Create Education Plan') }}</flux:heading> // Changed text
            <flux:subheading>
                {{ __('Fill in the details to create a new education plan.') }} // Changed text
            </flux:subheading>
        </div>
        ...
        <form wire:submit="store" class="space-y-4">
            ...
            <div class="flex justify-end gap-2">
                ...
                <flux:button type="submit">
                    {{ __('Create Education Plan') }} // Changed text
                </flux:button>
            </div>
        </form>
    </flux:card>
